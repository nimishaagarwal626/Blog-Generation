...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/Users/nimishaagarwal/Blog Generation/venv/bin',
 'BINLIBDEST': '/Users/nimishaagarwal/Blog Generation/venv/lib/python3.11',
 ...
 'BLDSHARED': 'clang -bundle -undefined '
              ...
              ''
              ''
              '-Wl,-rpath,/Users/nimishaagarwal/Blog Generation/venv/lib '
              '-L/Users/nimishaagarwal/Blog Generation/venv/lib '
              ''
              ''
              ''
              ''
 ...
 'CFLAGS': '-DNDEBUG -fwrapv -O2 -Wall '
           ...
           '-fPIC   -O2  '
           '-isystem '
           '/Users/nimishaagarwal/Blog Generation/venv/include '
           ''
           ''
           '-arch arm64  '
           ''
 ...
 'CONFIGURE_CPPFLAGS': ''
                       ...
                       '-I/Users/nimishaagarwal/Blog Generation/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      ''
                      ''
 ...
 'CONFIG_ARGS': "'--prefix=/Users/nimishaagarwal/Blog Generation/venv'"
                "'--build=arm64-apple-darwin20.0.0'"
                "'--host=arm64-apple-darwin20.0.0''--enable-ipv6'"
                "'--with-ensurepip=no'"
                "'--with-tzpath=/Users/nimishaagarwal/Blog Generation/venv/share/zoneinfo:/Users/nimishaagarwal/Blog Generation/venv/share/tzinfo'"
                "'--with-computed-gotos''--with-system-ffi'"
                "'--enable-loadable-sqlite-extensions'"
                "'--with-tcltk-includes=-I/Users/nimishaagarwal/Blog Generation/venv/include'"
                "'--with-tcltk-libs=-L/Users/nimishaagarwal/Blog Generation/venv/lib "
                ...
                "'PKG_CONFIG_PATH=/Users/nimishaagarwal/Blog Generation/venv/lib/pkgconfig'"
                ...
                '-mmacosx-version-min=11.1 '
                "-I/Users/nimishaagarwal/Blog Generation/venv/include'",
 'CONFINCLUDEDIR': '/Users/nimishaagarwal/Blog Generation/venv/include',
 'CONFINCLUDEPY': '/Users/nimishaagarwal/Blog Generation/venv/include/python3.11',
 'COREPYTHONPATH': '',
 ...
 'DESTDIRS': '/Users/nimishaagarwal/Blog Generation/venv '
             '/Users/nimishaagarwal/Blog Generation/venv/lib '
             '/Users/nimishaagarwal/Blog Generation/venv/lib/python3.11 '
             '/Users/nimishaagarwal/Blog Generation/venv/lib/python3.11/lib-dynload',
 'DESTLIB': '/Users/nimishaagarwal/Blog Generation/venv/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/Users/nimishaagarwal/Blog Generation/venv/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Users/nimishaagarwal/Blog Generation/venv/include '
                   '/Users/nimishaagarwal/Blog Generation/venv/include '
                   '/Users/nimishaagarwal/Blog Generation/venv/include/python3.11 '
                   '/Users/nimishaagarwal/Blog Generation/venv/include/python3.11',
 'INCLUDEDIR': '/Users/nimishaagarwal/Blog Generation/venv/include',
 'INCLUDEPY': '/Users/nimishaagarwal/Blog Generation/venv/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/Users/nimishaagarwal/Blog Generation/venv/lib/python3.11',
 'LIBDIR': '/Users/nimishaagarwal/Blog Generation/venv/lib',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/Users/nimishaagarwal/Blog Generation/venv/include',
 'LIBM': '',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Users/nimishaagarwal/Blog Generation/venv/lib/pkgconfig',
 'LIBPL': '/Users/nimishaagarwal/Blog Generation/venv/lib/python3.11/config-3.11-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Users/nimishaagarwal/Blog Generation/venv/lib/python3.11',
 ...
 'MANDIR': '/Users/nimishaagarwal/Blog Generation/venv/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/Users/nimishaagarwal/Blog Generation/venv/include',
 'MODULE_BINASCII_LDFLAGS': '-L/Users/nimishaagarwal/Blog Generation/venv/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/Users/nimishaagarwal/Blog Generation/venv/include',
 'MODULE_ZLIB_LDFLAGS': '-L/Users/nimishaagarwal/Blog Generation/venv/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/Users/nimishaagarwal/Blog Generation/venv/include',
 ...
 'MODULE__HASHLIB_LDFLAGS': '-L/Users/nimishaagarwal/Blog Generation/venv/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/Users/nimishaagarwal/Blog Generation/venv/include',
 'MODULE__LZMA_LDFLAGS': '-L/Users/nimishaagarwal/Blog Generation/venv/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/Users/nimishaagarwal/Blog Generation/venv/include '
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/Users/nimishaagarwal/Blog Generation/venv/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/Users/nimishaagarwal/Blog Generation/venv/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/Users/nimishaagarwal/Blog Generation/venv/lib  '
                        '-lssl -lcrypto',
 ...
 'MODULE__TKINTER_CFLAGS': '-I/Users/nimishaagarwal/Blog Generation/venv/include '
                           '-Wno-strict-prototypes -DWITH_APPINIT=1',
 'MODULE__TKINTER_LDFLAGS': '-L/Users/nimishaagarwal/Blog Generation/venv/lib '
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Users/nimishaagarwal/Blog Generation/venv/include',
 'OPENSSL_LDFLAGS': '-L/Users/nimishaagarwal/Blog Generation/venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/Users/nimishaagarwal/Blog Generation/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/Users/nimishaagarwal/Blog Generation/venv/share/zoneinfo:/Users/nimishaagarwal/Blog Generation/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'WASM_ASSETS_DIR': './Users/nimishaagarwal/Blog Generation/venv',
 'WASM_STDLIB': './Users/nimishaagarwal/Blog Generation/venv/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'datarootdir': '/Users/nimishaagarwal/Blog Generation/venv/share',
 'exec_prefix': '/Users/nimishaagarwal/Blog Generation/venv',
 'prefix': '/Users/nimishaagarwal/Blog Generation/venv',
